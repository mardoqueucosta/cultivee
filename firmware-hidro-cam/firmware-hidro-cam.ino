...
void registerOnServer() {
  ...
  // Monta ctrl_data com estado da hidro-cam
  int cycleDay = getCycleDay();
  int phaseIdx = getCurrentPhaseIndex();
  Phase *p = &phases[phaseIdx];
...
<p style='color:#aaa;font-size:0.75rem;margin-top:6px'>Controle local via rede Cultivee-HidroCam</p>
</div>
...
setTimeout(tick,800);
var appUrl='https://hidro-cam.cultivee.com.br?code=)rawliteral" + shortId + R"rawliteral(';
...
<a href='https://hidro-cam.cultivee.com.br?code=)rawliteral" + shortId + R"rawliteral(' class='btn' style='margin-top:8px;display:block;text-align:center'>Abrir App</a>
</div>
</div></body></html>)rawliteral";
